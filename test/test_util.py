...
class TestUtil(unittest.TestCase):
    ...
    def test_image_encoder_b64(self):
        ...
        # error messages
        value_error_msg = f"No file found at location: '{non_existing_file_name}'."
        type_error_msg = (
            "'image_or_image_path' should be an image path or a binary-read file io.BufferedReader."
        )
        ...
        check_error_message(self, error, type_error_msg)
    ...
    def test_generate_local_beacon(self, mock_get_valid_uuid):
        ...
        self.assertEqual(
            beacon,
            {"beacon" :"weaviate://localhost/fcf33178-1b5d-5174-b2e7-04a2129dd35b"},
        )
    ...
    def test_get_valid_uuid(self):
        ...
        # invalid formats
        type_error_msg = lambda d: f"'uuid' must be of type str or uuid.UUID. Given type: {d}."
        value_error_msg = "Not valid 'uuid' or 'uuid' can not be extracted from value."
    ...
    def test_uuid5(self, mock_uuid):

        result = uuid5('TestID!', 'Test!')
